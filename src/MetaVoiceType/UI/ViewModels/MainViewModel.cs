...
public partial class MainViewModel : ObservableObject, IDisposable
{
    ...
    private Dictionary<VoiceCommand, string> CurrentPhrases() => new()
    {
        ...
        [VoiceCommand.PasteHere] = PasteHerePhrase,
    ...
    private async Task RunDownloadAsync(Func<CancellationToken, Task> operation)
    {
        ...
        catch (Exception ex) { DownloadFailed = true; DownloadStatus = "Download failed: " + ex.Message; State.VoiceModelState = State.VoiceModelState == "Downloading" ? "Failed" : State.VoiceModelState; State.DictationModelState = State.DictationModelState == "Downloading" ? "Failed" : State.DictationModelState; }
